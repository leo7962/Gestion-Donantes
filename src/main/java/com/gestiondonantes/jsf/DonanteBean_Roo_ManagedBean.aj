...
import com.gestiondonantes.jsf.util.MessageFactory;
...
privileged aspect DonanteBean_Roo_ManagedBean {
    ...
    public HtmlPanelGrid DonanteBean.populateCreatePanel() {
        ...
        mailCreateInputRegexValidator.setPattern("[a-a-zA-Z0-9]+@[a-zA-Z0-9]+.[a-zA-Z0-9]+.[a-zA-Z0-9]+");
    ...
    public HtmlPanelGrid DonanteBean.populateEditPanel() {
        ...
        mailEditInputRegexValidator.setPattern("[a-a-zA-Z0-9]+@[a-zA-Z0-9]+.[a-zA-Z0-9]+.[a-zA-Z0-9]+");
